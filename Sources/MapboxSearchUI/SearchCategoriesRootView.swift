    ...
    func handleTabSwitch() {
        UIView.animate(
            ...
            animations: { [weak self] in
                ...
                self.contentScrollView.contentOffset.x =
                self.segmentedControl.selectedTab.horizontalOffsetFor(scrollView: self.contentScrollView)
        })
    }
}
...
fileprivate extension CategoriesFavoritesSegmentControl.Tab {
    ...
    init(scrollViewPageProgress: CGFloat, direction: UIUserInterfaceLayoutDirection) {
